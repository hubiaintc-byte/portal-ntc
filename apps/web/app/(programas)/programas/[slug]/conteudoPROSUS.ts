...
export const PROSUS: ConteudoPrograma = {
  ...
  hero: {
    ...
    ctas: [
      { rotulo: "Solicitar proposta", href: "/contato?programa=prosus", variante: "gold" },
      { rotulo: "Solicitar folder",   href: "/contato?programa=prosus&assunto=folder", variante: "ghost-light" },
    ],
  },
  metaBar: [
...
<div class="modes-grid">
  <article class="mode-card-prog featured">
    ...
    <a class="cta" href="/contato?programa=prosus&modalidade=trilha">Solicitar proposta da trilha →</a>
  </article>
  ...
  <article class="mode-card-prog">
    ...
    <a class="cta" href="/contato?programa=prosus&modalidade=incompany">Solicitar proposta in company →</a>
  </article>
  <article class="mode-card-prog">
    ...
    <a class="cta" href="/contato?programa=prosus&modalidade=sob-medida">Solicitar proposta sob medida →</a>
  </article>
</div>`,
  },
  modulosAbertos: {
    ...
    bottomCtas: [
      ...
      { rotulo: "Solicitar inscrição institucional", href: "/contato?programa=prosus&assunto=inscricao", primario: false },
    ],
  },
  faq: {
