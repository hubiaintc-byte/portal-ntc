          ...
          <div className="legal-grid">
            ...
            <div className="legal-content">
              ...
              <section id="pagamentos" className="legal-section">
                ...
                <p>Para contratos institucionais, aplicam-se as cláusulas específicas do instrumento firmado (contrato administrativo, termo de cooperação ou termo de adesão). As contratações públicas decorrentes destes Termos ocorrem <strong>exclusivamente por contratação direta nas hipóteses de dispensa ou inexigibilidade fundamentadas na Lei n.º 14.133/2021</strong>, conforme detalhado na página de <a href="#">Soluções</a>. Estes Termos não disciplinam, e o Instituto NTC do Brasil não participa, de procedimentos de pregão, concorrência tradicional, credenciamento genérico ou ata de registro de preços para a entrega formativa aqui prevista.</p>
